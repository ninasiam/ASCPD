function [A_est, error, F_value, f_val_A_est, f_val_Y] = BrasCPD_vol3(T,options)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    F_value2 = [compute_fval(frob_X, A_init, T)];
...
%         MSE_measure(A_est{3},A_true{3}));
    ...
    for iter = 1:MAX_ITER 
        ...
        A_est{n} = A_next{n};
%         f_val_A_est = [f_val_A_est frob(T - cpdgen(A_est))];
%         f_val_Y = [f_val_Y frob(T - cpdgen(Y))];
...
%         end
        ...
        if(mod(iter,3*iter_per_epoch) == 0 && iter > 0)
            ...
            f_val2 = compute_fval(frob_X, A_est, T);                                 
            F_value = [F_value f_val];
            F_value2 = [F_value2 f_val2]
