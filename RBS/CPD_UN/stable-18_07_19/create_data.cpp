...
int main(int argc, char **argv){
	int I = 160;//400;//5000;//1008;//3024;//					// | Dimensions
	int J = 200;  //400;//320;//1008;//112;//						// | and rank
	int K = 240;  //50000;//5000;//1008;//3024;//					// | of the
	int F = 10;										// | Tensor
	...
	//MatrixXd kr_BA(I*J, F);
	//MatrixXd X_C(K, I*J);
	//MatrixXd X_C_T(I*J, K);
	//Khatri_Rao_Product(B, A, kr_BA);
	//X_C.noalias() = C * kr_BA.transpose();
	//X_C_T = X_C.transpose();
	...
	//Write_to_File(I*J, K, X_C_T, "Data_cpp/X_C.bin");
