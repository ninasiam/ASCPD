...
void Workerjob(omp_obj omp_var, size_t J, size_t K, MatrixXd &A, const Ref<const MatrixXd> C_T_C, const Ref<const MatrixXd> A_T_A, const Ref<const MatrixXd> X_A, const Ref<const MatrixXd> Kr, double delta_1, double delta_2, int factor);

void Workerjob_C(omp_obj omp_var, size_t I, size_t J, MatrixXd &C, MatrixXd &W_C, const Ref<const MatrixXd> B_T_B, const Ref<const MatrixXd> A_T_A, const Ref<const MatrixXd> X_C, const Ref<const MatrixXd> Kr, double delta_1, double delta_2);
